...
levelGenRegister<GenParamsWrapBrogue>({
  type: 'brogue',
  generate(floor_id, seed, params) {
    return generateLevelBrogue(floor_id, seed, params.brogue || default_gen_params_brogue);
  },
  connect(generator, floor_id, seed, params) {
    connectLevelBrogue(generator, floor_id, seed, params.brogue || default_gen_params_brogue);
  },
});
