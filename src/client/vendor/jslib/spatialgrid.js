...
var SpatialGrid = (function () {
    ...
    SpatialGrid.prototype.add = function (externalNode, extents) {
        ...
        debug.assert(0 <= minX && maxX < numCellsX && 0 <= minRow && maxRow < this.cells.length, "Node is out of bounds.");
    ...
    SpatialGrid.prototype.update = function (externalNode, extents) {
        ...
        if (index !== undefined) {
            ...
            debug.assert(0 <= newMinX && newMaxX < numCellsX && 0 <= newMinRow && newMaxRow < this.cells.length, "Node is out of bounds.");
            ...
            if (oldMinX !== newMinX || oldMinRow !== newMinRow || oldMaxX !== newMaxX || oldMaxRow !== newMaxRow) {
                        ...
                        if (internalRow && cs < ci && ci < ce) {
                            do {
                                ...
                                if (node.queryIndex !== queryIndex) {
                                    ...
                                    nodeExtents = node.extents;
                                    if (queryMinY <= nodeExtents[4] && queryMaxY >= nodeExtents[1]) {
                            ...
                            do {
                                ...
                                if (node.queryIndex !== queryIndex) {
                                    ...
                                    nodeExtents = node.extents;
                                    if (queryMinX <= nodeExtents[3] && queryMinY <= nodeExtents[4] && queryMinZ <= nodeExtents[5] && queryMaxX >= nodeExtents[0] && queryMaxY >= nodeExtents[1] && queryMaxZ >= nodeExtents[2]) {
                                        overlappingNodes[storageIndex] = node.externalNode;
                                        storageIndex += 1;
                                        numOverlappingNodes += 1;
                                    }
