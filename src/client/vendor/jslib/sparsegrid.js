...
var SparseGridNode = (function () {
    ...
    SparseGridNode.create = function (extents, cellExtents, id, externalNode) {
...
var SparseGridCell = (function () {
    ...
    // Constructor function
    SparseGridCell.create = function (x, z, node) {
...
var SparseGrid = (function () {
    ...
    SparseGrid.prototype.add = function (externalNode, extents) {
        ...
        debug.assert(-32767 <= minX && maxX <= 32767 && -32767 <= minZ && maxZ <= 32767, "Node is out of bounds.");
        ...
        if (index !== undefined) {
            ...
            if (nodeExtents[0] !== min0 || nodeExtents[2] !== min2 || nodeExtents[3] !== max0 || nodeExtents[5] !== max2) {
                ...
                if (oldMinX !== newMinX || oldMinZ !== newMinZ || oldMaxX !== newMaxX || oldMaxZ !== newMaxZ) {
                    debug.assert(-32767 <= newMinX && newMaxX <= 32767 && -32767 <= newMinZ && newMaxZ <= 32767, "Node is out of bounds.");
    ...
    SparseGrid.prototype._hash = function (x, z) {
        ...
        var hz = (az >> 8);
        var lz = (az & 0xff);
        return ((hx << 25) | (hz << 18) | (lx << 10) | (lz << 2) | ((x >>> 14) & 2) | ((z >>> 15) & 1));
    ...
    SparseGrid.prototype._flagCells = function (nodeMinY, nodeMaxY, minX, minZ, maxX, maxZ) {
        var cellsMap = this.cellsMap;
        var z = minZ;
        do {
            var x = minX;
    ...
    SparseGrid.prototype._getVisibleNodesBruteForce = function (planes, visibleNodes, startIndex) {
        var numVisibleNodes = 0;
        var numPlanes = planes.length;
        var storageIndex = (startIndex === undefined) ? visibleNodes.length : startIndex;
        var nodes = this.nodes;
